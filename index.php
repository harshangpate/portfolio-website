         ...
         <div class="nine columns main-col">
            ...
            <div class="row">
               ...
               <div class="columns download">
                  <p>
                     <a href="download.php" class="button"><i class="fa fa-download"></i> Download Resume</a>
                  </p>
               </div>
   ...
   <section id="resume">
      ...
      <div class="row skill">
         ...
         <div class="nine columns main-col">
            ...
            <p>
               <p>Welcome to the toolkit that powers my digital journey! Here’s a glimpse into the skills I’ve honed along the way:</P>

               <p>C & C++: Building the foundation with these powerful languages, I’ve developed a strong understanding of logic and problem-solving that brings efficiency to every project.</P>

               <p>WordPress: Crafting beautiful and functional websites on WordPress, I bring ideas to life with seamless content management and custom styling, making every site unique.</P>

               <p>CSS: From clean, minimalist designs to vibrant, interactive layouts, I use CSS to add style and visual appeal, ensuring each web project leaves a lasting impression.</P>

               <p>HTML5: The backbone of every web page I create, HTML5 allows me to structure information clearly and enhance the user experience with semantic, well-organized content.</P>

               <p>jQuery: For a touch of magic, I turn to jQuery to add dynamic, responsive elements, making websites interactive and enhancing user engagement.</P>

               <p>Each of these skills fuels my passion for development, enabling me to create visually stunning, user-friendly projects. Together, they represent a versatile toolkit, ready to bring any digital vision to life!</P>
            </p>

        <div class="bars">

           <ul class="skills">
             <li><span class="bar-expand photoshop"></span><em>C</em></li>
                  <li><span class="bar-expand illustrator"></span><em>C++</em></li>
   ...
   <section id="portfolio">
      ...
      <div class="row">
         ...
         <div class="twelve columns collapsed">
            ...
            <h1>Here are some projects that i have done.</h1>
